<?php get_header(); ?>
 <div class="wrapper-conoce-veracruz textura">
    <div class="container">
        <div class="row">
            <div class="col align-Center-title-conoce-veracruz">
                <img class="hornaments-quienes-somos pr-3" src="<?php echo get_template_directory_uri();?>/images/hornament.png">
                <h3 class="title-conoce-veracruz"> <span>CONOCE</span> VERACRUZ</h3>
                <img class="hornaments-quienes-somos pl-3" src="<?php echo get_template_directory_uri();?>/images/hornament.png">
            </div>
        </div>
    </div>
