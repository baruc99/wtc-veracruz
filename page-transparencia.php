...
<div class="wrapper-transparencia textura">
    <div class="container">
        <div class="row">
            <div class="col d-flex-9">
                <img class="hornaments-quienes-somos" src="<?php echo get_template_directory_uri();?>/images/hornament.png">
                <h3 class="title-seccion-trasnparencia"> TRANSPARENCIA </h3>
                <img class="hornaments-quienes-somos" src="<?php echo get_template_directory_uri();?>/images/hornament.png">
            </div>
        </div>
        <div class="row transparencia-text">
            ...
            <div class="col-6">
                ...
                <p><span>Manual del Funcionamiento del Subcomité de Adquisiciones.</span></p>
                <p>El presente Manual tiene como objetivo, determinar la forma en que se integrará y funcionará el Subcomité de Adquisiciones del Fideicomiso Público del Centro de Exposiciones y Convenciones de Veracruz.</p>
                <p><span>Programa Anual de Adquisiciones.</span></p>
            </div>
        </div>
    </div>
</div>
