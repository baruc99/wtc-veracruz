   ...
   <div class="container">
      <div class="row">
         <div class="col eslogan">
            <img src="<?php echo get_template_directory_uri();?>/images/hornament-before.png" class="hornament-before">
               <p>Veracruz tiene el <br></p>
               <p>espacio ideal para tu evento. <br></p>
               <p><span>¡Organiza con nosotros!</span></p>
            <img src="<?php echo get_template_directory_uri();?>/images/hornament-after.png" class="hornament-after">
         </div>
      </div>
   </div>
</section>
